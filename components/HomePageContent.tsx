    ...
    <>
      ...
      <main>
        ...
        <section id="about" className="container-max py-14">
          ...
          <p className="mt-4 text-charcoal/80 leading-relaxed">{t("home.about.body")}</p>
        </section>
        ...
        <section id="services" className="container-max py-14">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-sage/60 bg-white p-6 shadow-soft">
              ...
              <p className="mt-2 text-charcoal/75">{t("home.services.initialBody")}</p>
            </div>
            <div className="rounded-2xl border border-sage/60 bg-white p-6 shadow-soft">
              <h3 className="text-xl font-semibold">{t("home.services.followupTitle")}</h3>
              <p className="mt-2 text-charcoal/75">{t("home.services.followupBody")}</p>
            </div>
            <div className="rounded-2xl border border-sage/60 bg-white p-6 shadow-soft">
              <h3 className="text-xl font-semibold">{t("home.services.onlineTitle")}</h3>
              <p className="mt-2 text-charcoal/75">{t("home.services.onlineBody")}</p>
            </div>
          </div>
        </section>
        ...
        <section id="why" className="container-max py-14">
          ...
          <p className="mt-4 text-charcoal/80 leading-relaxed">{t("home.why.body")}</p>
        </section>

        <ScrollGallery src="/images/gallery-4.jpg" title={t("scroll.holisticTitle")} body={t("scroll.holisticBody")} />
        <ScrollGallery
        ...
        <section id="contact" className="container-max py-14">
          ...
          <p className="mt-4 text-charcoal/80 leading-relaxed">{t("home.contact.body")}</p>
